...
def generate_sample_data(row_count=100):
    ...
    'Loan_ID': np.random.permutation(np.random.randint(0,
                                                       row_count,
                                                       size=int(row_count/10)) + user_id_sentinel).tolist()*10,
    'Loan_Amount_Requested': np.random.permutation(np.random.randint(0,
                                                          row_count,
                                                          size=int(row_count/10))+ product_id_sentinel).tolist()*10 ,
    'Lenght_Employed': np.random.permutation(np.random.randint(1,
                                                                  42,
                                                                  size=row_count)),
    'Home_Owner': np.round(np.abs(np.random.randn(row_count)+1)*price_sentinel,
                      decimals=2),
    'Annual_Income':np.random.permutation([chr(random.randrange(97, 97 + 3 + 1)) 
